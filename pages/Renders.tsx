    ...
    <>
      <div className="h-screen bg-slate-200 overflow-hidden relative">
        ...
        <div className="px-8 py-5 space-y-2 bg-gradient-to-l from-transparent to-white">
          <h1 className="font-semibold text-5xl text-center lg:text-left">
            Room Render
          </h1>
          <h1 className="font-light text-3xl text-center lg:text-left">
            Made with Blender by Aaron Matharoo
          </h1>
        </div>

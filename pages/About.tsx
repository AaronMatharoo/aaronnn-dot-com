        ...
        <div className="flex items-center p-10">
          <div className=" space-y-5">
            ...
            <h1 className="text-xl font-light text-[#5d00d7]">
              PEN-TESTER | APPLICATION ENGINEER | ETHICAL HACKER
            </h1>
          </div>
        </div>
        <div>
      ...
      {/* <>
        ...
        <div className="grid lg:grid-cols-2 grid-flow-row">
          ...
          <div className="p-10 pb-20 space-y-5">
            ...
            <div className="space-y-5">
              <h1 className="font-light text-xl">
                I'm
                <span className="text-[#5d00d7] font-semibold"> Aaron</span>!
              ...
              <h1 className="font-light text-xl">
                ...
                <span className="text-[#5d00d7] font-semibold">
                  I am all over North America
                </span>
                , working and living in both Canada & the United States!
              </h1>
            </div>
          </div>
          ...
          <div className="p-10 space-y-5">
            ...
            <div className="space-y-5">
              ...
              <h1 className="font-light text-xl">
                ...
                <span className="font-semibold"> engineering firms</span>,
                leading magazine production teams, building my own
                <span className="font-semibold text-[#5d00d7]">
                  {" "}
              ...
              <h1 className="font-light text-xl">
                My passion for engineering and technology led me to contribute
                to multiple firms, and my creative side thrived through various
                team projects.
              </h1>
            </div>
          ...
          <div className="px-10 pb-20 space-y-5">
            ...
            <div className="space-y-5">
              <h1 className="font-light text-xl">
                My mission is to make a tangible difference in the tech
                landscape by collaborating with teams that push boundaries and
                embrace new challenges. Technology isn't just a career for me;
              ...
              <h1 className="font-light text-xl">
                Outside of the tech realm, you'll find me at the gym, indulging
                my need for speed through sim racing, or listening to good
                music. As for what's next in my professional career,{" "}
                <span className="underline decoration-[#5d00d7] font-semibold">
                  impactful solutions for web and application development
                </span>{" "}
                is at the forefront of my sights. Beyond that, exploring the
                realm of{" "}
                <span className="text-[#5d00d7] font-semibold">
                  cybersecurity and information technology
                </span>{" "}
                to see how we can produce more robust, long term solutions is
          ...
          <div className="hover:text-[#5d00d7] underline py-5 mt-10 lg:flex justify-center text-center bg-[#ffffff] lg:col-span-2 col-span-1 px-5 lg:px-0">
            <h1>
              Details of this site can be found in the public repository on my
              GitHub @AaronMatharoo (aaronmatharoo)
            </h1>
          </div>
        </div>
      </> */}

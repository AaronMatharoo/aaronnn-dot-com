  ...
  const NavButton = ({
    ...
    return (
      <a onClick={() => handleRoute(link)}>
        <div className=" hover:text-white hover:bg-[#5d00d7] bg-[#f0f0f5] border-2 border-black hover:scale-95 duration-100 hover:border-2 hover:font-bold hover:cursor-pointer active:scale-90 py-1 justify-center flex">
